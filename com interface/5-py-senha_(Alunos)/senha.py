...
def new_rand():
    ...
    pw_lenght = int(my_entry.get()) if my_entry.get() else 0
    my_password = ''.join(chr(randint(33, 126))for _ in range (pw_lenght))
...
try:
    create_image = ctk.CTkImage(light_image=Image.open(resource_path("create.png")), dark_image=Image.open
    (resource_path("create.png")), size=(20, 20))
    copy_image = ctk.CTkImage(light_image=Image.open(resource_path("copy.png")), dark_image=Image.open
    (resource_path("copy.png")), size=(20, 20))
    clean_image = ctk.CTkImage(light_image=Image.open(resource_path("clean.png")), dark_image=Image.open
    (resource_path("clean.png")), size=(20, 20))
except Exception as e:
...
clip_button = ctk.CTkButton(my_frame, text="Copiar", command=clipper, image=copy_image, compound="left", font=
("Helvetica", 16))
